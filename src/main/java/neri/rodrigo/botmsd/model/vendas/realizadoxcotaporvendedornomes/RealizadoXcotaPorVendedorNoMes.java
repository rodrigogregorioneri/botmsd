package neri.rodrigo.botmsd.model.vendas.realizadoxcotaporvendedornomes;

import neri.rodrigo.botmsd.model.vendas.realizadoxcotaporprodutoevendedor.IRealizadoXcotaPorProdutoEvendedor;

public class RealizadoXcotaPorVendedorNoMes {
    ...
    public RealizadoXcotaPorVendedorNoMes() {
    }

    public RealizadoXcotaPorVendedorNoMes(String grupoMercado, String produto, String ano, String mes, String valorLiquidoCota, String valorLiquido) {
    ...
    public void iResponseToResponseTest(IRealizadoXcotaPorVendedorNoMes iResponse){
    ...
    public String toString() {
        return " " +
                ...
                ", Ano: " + ano + '\'' +
                ", Mes: " + mes + '\'' +
                ", Valor LiquidoCota: " + valorLiquidoCota + '\'' +
